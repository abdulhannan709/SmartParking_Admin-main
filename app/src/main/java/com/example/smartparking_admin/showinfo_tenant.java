...
public class showinfo_tenant extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_showinfo_tenant, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        addresstxt = getActivity().findViewById(R.id.ttdetailaddress);
        fnametxt = getActivity().findViewById(R.id.ttdetailfname);
        lnametxt = getActivity().findViewById(R.id.ttdetaillname);
        emailtxt = getActivity().findViewById(R.id.ttdetailemail);
        phonetxt = getActivity().findViewById(R.id.ttdetailphone);
        delbtn = getActivity().findViewById(R.id.tt_delbtn);

        db = FirebaseFirestore.getInstance();

        DocumentReference docRef = db.collection("tenant").document(email);
